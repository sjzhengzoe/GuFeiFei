...
// 处理entry路径
// {
//   "reactTest/index": "./src/pages/reactTest/index.jsx",
//   "moreOnePagesTest/index": "./src/pages/moreOnePagesTest/index.jsx",
// }
exports.handleEntry = () => {
  let entryObj = {};
  ...
  paths.map((item) => {
    ...
    let outputFilePath = `${entryFileName}/index`;
  ...
  paths.map((item) => {
    ...
    htmlArr.push(
      new htmlWebpackPlugin({
        ...
        filename: `./pages/${entryFileName}/index.html`,
        inject: "body",
        favicon: "./src/global/img/favicon.ico",
        chunks: [`${entryFileName}/index`],
      })
    );
  });
